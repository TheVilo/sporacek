# Morčacie nudličky s restovanou zeleninou

**slug:** morcacie-nudlicky-restovana-zelenina
**porcie:** 2
**čas prípravy:** 25 minút
**foto_url:** fotky/morcacie-nudlicky-restovana-zelenina.jpg

---

## Foto prompt
A bold, appetizing 45-degree angle editorial food photo, 9:16 format, blending warm minimalism with a lived-in lifestyle feel. Strips of golden turkey breast sautéed with colourful strips of pepper, zucchini and carrot in a shallow bowl over a smooth light wood table, glossy and fresh, sprinkled with parsley. A softly wrinkled linen napkin and a modern matte fork beside it. Soft, evenly diffused bright daylight — no harsh directional shadows, no dramatic side-lighting. No text, no logo, no watermark in the image.
...
## Tagy
`#obed` `#večera` `#morčacie` `#vysoký-proteín` `#do-20-minút`
