# Hovädzie burgery s cheddarom

**slug:** hovadzie-burgery-cheddar
**porcie:** 4
**čas prípravy:** 30 minút
**foto_url:** fotky/hovadzie-burgery-cheddar.jpg
...
| Surovina | Množstvo |
|---|---|
| Hovädzie mleté mäso | 600 g |
| Cheddar | 4 plátky |
| Burger žemle | 4 ks |
| Cibuľa | 1 ks |
| Paradajky | 1 ks |
| Šalát (hlávkový) | pár lístkov |
| Horčica | 2 ČL |
| Soľ, čierne korenie | — |
| Olivový olej | 1 PL |
...
## Tagy
`#večera` `#obed` `#hovädzie` `#sýte` `#do-20-minút`
