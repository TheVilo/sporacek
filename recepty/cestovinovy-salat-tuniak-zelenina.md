# Cestovinový šalát s tuniakom a chrumkavou zeleninou

**slug:** cestovinovy-salat-tuniak-zelenina
**porcie:** 2
**čas prípravy:** 20 minút
**foto_url:** fotky/cestovinovy-salat-tuniak-zelenina.jpg

---

## Foto prompt
"A bright, fresh lifestyle food photo in a 9:16 format, in the style of a popular food blog. Tuna pasta salad: short pasta (fusilli) tossed with flaked tuna, halved cherry tomatoes, cucumber pieces, sweet corn and thin red onion slices in a light creamy yogurt dressing, in a wide ceramic bowl. Fresh and colorful, fork on a linen napkin, wooden table, bright natural daylight. No text, no logo, no watermark in the image."
...
|---|---|
| Cestoviny | 200 g |
| Tuniak v konzerve | 170 g |
| Cherry paradajky | 150 g |
| Uhorka | ½ ks |
| Kukurica (konzervovaná) | 140 g |
| Červená cibuľa | ½ ks |
| Jogurt biely | 150 g |
| Horčica | 1 ČL |
| Citrón | ½ ks (šťava) |
...
## Tagy
`#šalát` `#ryba` `#vysoký-proteín` `#ľahké` `#do-20-minút`
