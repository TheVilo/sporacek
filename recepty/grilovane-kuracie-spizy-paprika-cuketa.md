# Grilované kuracie špízy s paprikou a cuketou

**slug:** grilovane-kuracie-spizy-paprika-cuketa
**porcie:** 2
**čas prípravy:** 35 minút (+ 30 min marinovania)
**foto_url:** fotky/grilovane-kuracie-spizy-paprika-cuketa.jpg

---

## Foto prompt
A bright, airy, dynamic 45-degree angle editorial shot, 9:16 format. Capturing an elevated home cooking style with grilled chicken skewers alternating with charred bell pepper and zucchini pieces, showing nice grill marks, in a modern matte bowl on a clean oak surface. Right next to it is a contemporary dish of lemon wedges, tying into the meal. A modern brushed fork leans casually on the bowl. A few pieces of fresh oregano scattered naturally on the table for that authentic lifestyle touch. The grilled chicken and vegetables look vibrant and smoky. Soft, welcoming daylight. No text, no logo, no watermark in the image.
...
## Tagy
`#večera` `#kura` `#vysoký-proteín` `#ľahké`
