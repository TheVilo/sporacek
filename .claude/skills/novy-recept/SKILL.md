...
Recepty sú nezastarateľná databáza — suroviny, množstvá, postup, fotka. **Žiadna cena, nikde.** Cena sa počíta až vtedy, keď niekto skladá konkrétny týždeň alebo custom výber (`.claude/skills/tyzdenny-vystup/SKILL.md`), z aktuálnych cien v danej chvíli — nie pri tvorbe receptu.
