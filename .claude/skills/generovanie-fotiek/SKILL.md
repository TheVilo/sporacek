...
9. **Slovenské halušky/strapačky — ťažký prípad pre Gemini.** Model osciluje: „Spätzle" → dlhé rezance (zle), „potato dumplings/gnocchi" → hladké okrúhle guľky (zle). Reálne halušky sú medzi tým (malé nepravidelné hrudky). Najbližšie sa dostaneš formuláciou: „traditional Slovak haluški: a pile of small, irregular, lumpy, rough-surfaced little pieces of grated-potato dough, each about 1.5 cm, with uneven torn homemade shapes — explicitly NOT smooth round balls and NOT long noodles, rustic and clearly hand-scraped". Výsledok býva mierne okrúhlejší než v realite — je to strop modelu, neprežeň to donekonečna regeneráciami. Platí pre bryndzové halušky, strapačky, halušky s kapustou a pod.
